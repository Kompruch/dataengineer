...
def process_log_file(cur, filepath):
    ...
    Description: This function can be used to read the file in the filepath (data/log_data)
      to get the time and user info and used to populate the users and time dim tables.
    ...
    column_labels = ('start_time', 'hour', 'day', 'week', 'month', 'yaer', 'weekday')
...
def process_data(cur, conn, filepath, func):
    ...
    Arguments:
      cur: the cursor object. 
      con: psycopg2.connect("host=127.0.0.1 dbname=sparkifydb user=student password=student") used to access postgresql database
      filepath: file path.
      func: pass function want to perform on the files
